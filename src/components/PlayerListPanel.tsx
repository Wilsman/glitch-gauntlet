    ...
    <div className="absolute top-4 left-4 flex flex-col gap-2 z-30">
      {players.map((player) => {
        ...
        return (
          <div
            key={player.id}
            className={`w-64 p-2 border-2 bg-black/70 backdrop-blur-sm transition-all duration-300 ${
          ...
          >
            ...
            <div className="mb-1">
              <div className="flex justify-between items-center mb-1">
                <span className="font-vt323 text-[10px] text-red-400">HP</span>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                <span className="font-vt323 text-[10px] text-purple-400">XP</span>
                <span className="font-vt323 text-[10px] text-white">

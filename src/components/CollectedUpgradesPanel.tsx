...
export default function CollectedUpgradesPanel({ upgrades }: CollectedUpgradesPanelProps) {
  ...
  return (
    <div className="fixed left-0 top-1/2 -translate-y-1/2 w-64 bg-black/90 border-2 border-neon-yellow backdrop-blur-sm z-30 transition-transform duration-300 hover:translate-x-0 -translate-x-[calc(100%-2rem)] group">
      {/* Hover Tab */}
      ...
      <div className="p-2">
        ...
        <div className="space-y-1 max-h-[calc(70vh-4rem)] overflow-y-auto pr-1">

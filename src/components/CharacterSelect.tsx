                ...
                {characters.map((char) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Stats */}
                      <div className="space-y-3 mb-6 font-vt323 text-base">
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden border border-white/5">
                            <div
                              className="h-full bg-neon-yellow shadow-[0_0_8px_#FFFF00]"
                              style={{
                                width: `${(char.baseDamage / 50) * 100}%`,
                              }}
                            />
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-1">
                          <div className="flex justify-between text-white px-1">
                            <span>CADENCE</span>
                            <span className="text-neon-pink">
                              {(1000 / char.baseAttackSpeed).toFixed(1)}/s
                            </span>
                          </div>
                          <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden border border-white/5">
                            <div
                              ...
                              style={{
                                width: `${
                                  (1000 / char.baseAttackSpeed / 8) * 100
                                }%`,
                              }}
                            />
                          </div>
                      ...
                      {isLocked && (
                        <div className="absolute inset-0 flex items-center justify-center bg-black/50 rounded-lg">
                          <div className="text-center">
                            ...
                            <div className="font-press-start text-xs text-gray-400">
                              LOCKED
                            </div>
                          </div>
                        </div>

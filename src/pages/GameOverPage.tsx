...
export default function GameOverPage() {
  ...
  return (
    <main className="min-h-screen w-full flex flex-col items-center justify-center p-4 overflow-hidden relative text-neon-cyan">
            ...
            >
              ...
              <div className="pt-8 space-y-8">
                ...
                <motion.div
                  ...
                  className="bg-black/60 border-2 border-neon-cyan p-6 rounded-lg"
                >
                  <h3 className="font-press-start text-2xl mb-4 text-neon-cyan">
      ...
      <SettingsPanel className="absolute right-4 top-0 z-30" />

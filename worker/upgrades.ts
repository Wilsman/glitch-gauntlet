...
export const ALL_UPGRADES: Omit<UpgradeOption, 'id'>[] = [
  ...
  { type: 'orbital', title: 'Orbiting Death Roomba', description: 'Spinning death orbs protect you. Also vacuums!', rarity: 'legendary', emoji: '🛸' },
  ...
  { type: 'orbital', title: 'Fidget Spinner of Doom', description: 'Spinning death orbs. Very 2017.', rarity: 'legendary', emoji: '🌀' },
